...
class FirebaseDataScreen123654 extends StatefulWidget {
  ...
  @override
  _FirebaseDataScreen123654State createState() =>
      _FirebaseDataScreen123654State();
}
...
class _FirebaseDataScreen123654State extends State<FirebaseDataScreen123654> {
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                _ref
                    .child("merge/${"merge/${widget.selectedNodeKey}"}")
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => DatabaseRename(
                        selectedNodeKey: "merge/${widget.selectedNodeKey}"),
                  ),
                );
  ...
  query: _ref.child("merge/${widget.selectedNodeKey}"),
                ...
                children: [
                  ...
                  if (!_isDeleteMode)
                    Switch(
                      ...
                      onChanged: (newValue) {
                        _ref
                            .child("merge/${widget.selectedNodeKey}")
                            .child(code)
          ...
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const FirebaseDataScreen1234(selectedNodeKey: '123',)),
                );
              },
